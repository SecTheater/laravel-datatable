                ...
                >
                    ...
                    >
                        <div
                            ...
                            :class="{ 'has-error': creating.errors[column] }"
                        >
                            <label
                                :for="column"
                            ...
                            <div class="col-md-6">
                                ...
                                <span
                                    class="help-block"
                                    v-if="creating.errors[column]"
                                >
                                    <strong
                                        >{{ creating.errors[column][0]</strong
                                    >
                                </span>
                            </div>
                        </div>
                            ...
                            <tr>
                                ...
                                <th v-for="column in response.displayable">
                                    <span
                                        ...
                                        @click="sortBy(column)"
                                        >{{
                                            response.custom_columns[column] ||
                                                column
                                        }}</span
                                    >
                                    <span
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                <strong
                                                    >{{
                                                    editing.errors[column][0]</strong
                                                >
                                            </span>
                                        </div>
                                    </template>
